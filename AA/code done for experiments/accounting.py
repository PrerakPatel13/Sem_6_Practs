...
def analyze_python_code(file_path):
    ...
    accounting_cost = {
        "push1": random.randint(1, 10),
        "pop1": random.randint(1, 10)
    }
    credit_bank = {
        "push_count": accounting_cost["push1"] * push_count - push_count,
        "pop_count": accounting_cost["pop1"] * pop_count - pop_count
    }

    print("Accounting Cost:", accounting_cost)
    print("Credit bank:", credit_bank)
